...
% Text added to manuscript    
	\begin{tcolorbox}[left = 1em, top = 1ex, bottom = 1ex, colupper=black, colback=white, adjusted title = From page XX]
    ...
    \newpage
    \begin{tcolorbox}[left = 1em, top = 1ex, bottom = 1ex, colupper=black, colback=white, adjusted title = From page XX (continued)]
...
\begin{figure}[h]
    \caption[Abbreviated Caption]{A really really really really really really really really really really really really really really really long figure caption to illustrate how you can make a shorter abbreviation in the table of contents.}
      \centering
      \includegraphics[width=\linewidth]{figures_tables/simple_scatter.pdf}
    ...
    \begin{table}[ht]\centering
            ...
            \centering
              \begin{threeparttable}
                ...
                \estauto{figures_tables/important_table}{5}{S[table-format=1.2,table-column-width=20mm]}
